...
namespace SpiceCraft.Server.Migrations
{
    ...
    partial class SpiceCraftContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpiceCraft.Server.IndentityModels.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.CartItem", b =>
                {
                    ...
                    b.HasKey("CartItemId")
                        .HasName("PK__CartItem__488B0B0A46427D9C");

                    b.HasIndex("ItemId");

                    b.HasIndex(new[] { "CartId", "ItemId" }, "UQ__CartItem__F69B3F8ED499727C")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.CustomerGiftCard", b =>
                {
                    ...
                    b.HasKey("CustomerGiftCardId")
                        .HasName("PK__Customer__F382824D4358AF99");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.CustomerReward", b =>
                {
                    ...
                    b.HasKey("CustomerRewardsId")
                        .HasName("PK__Customer__2E79ECCEF6E54D8C");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Enquiry", b =>
                {
                    ...
                    b.HasKey("EnquiryId")
                        .HasName("PK__Enquiry__0A019B7D95A055A1");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.EnquiryType", b =>
                {
                    ...
                    b.HasKey("EnquiryTypeId")
                        .HasName("PK__EnquiryT__BE8CFEFCAC2DE4C2");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.GiftCard", b =>
                {
                    ...
                    b.HasKey("GiftCardId")
                        .HasName("PK__GiftCard__9FBB0CC111149389");

                    b.HasIndex(new[] { "Code" }, "UQ__GiftCard__A25C5AA7D9CBB7D0")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Inventory", b =>
                {
                    ...
                    b.HasKey("InventoryId")
                        .HasName("PK__Inventor__F5FDE6B3F33BD1BA");

                    b.HasIndex(new[] { "ItemId" }, "UQ__Inventor__727E838AC11FADE2")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Invoice", b =>
                {
                    ...
                    b.HasKey("InvoiceId")
                        .HasName("PK__Invoices__D796AAB5739810E5");

                    b.HasIndex(new[] { "OrderId" }, "UQ__Invoices__C3905BCE8AB1C721")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.ItemCategory", b =>
                {
                    ...
                    b.HasKey("CategoryId")
                        .HasName("PK__ItemCate__19093A0B9D5291FE");

                    b.HasIndex("ParentCategoryId");

                    b.HasIndex(new[] { "CategoryName" }, "UQ__ItemCate__8517B2E001FDB44C")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.ItemImage", b =>
                {
                    ...
                    b.HasKey("ImageId")
                        .HasName("PK__ItemImag__7516F70CA7E7A181");

                    b.HasIndex("ItemId");

                    b.HasIndex(new[] { "ImageCode" }, "UQ__ItemImag__A7875E72E3660462")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Message", b =>
                {
                    ...
                    b.HasKey("MessageId")
                        .HasName("PK__Messages__C87C0C9CFEDEC91F");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Notification", b =>
                {
                    ...
                    b.HasKey("NotificationId")
                        .HasName("PK__Notifica__20CF2E12BE0B6BDB");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Order", b =>
                {
                    ...
                    b.HasKey("OrderId")
                        .HasName("PK__Orders__C3905BCFA6ADF6A7");

                    b.HasIndex("ShippingOptionId");

                    b.HasIndex("UserId");

                    b.HasIndex(new[] { "OrderDate", "UserId" }, "UQ__Orders__A7F88E8FEE00099C")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.OrderDetail", b =>
                {
                    ...
                    b.HasKey("OrderDetailsId")
                        .HasName("PK__OrderDet__9DD74DBD8DC68362");

                    b.HasIndex("ItemId");

                    b.HasIndex(new[] { "OrderId", "ItemId" }, "UQ__OrderDet__64B7B3F6D8E14281")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Payment", b =>
                {
                    ...
                    b.HasKey("TransactionId")
                        .HasName("PK__Payments__55433A6BE062ABE4");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Product", b =>
                {
                    ...
                    b.HasKey("ItemId")
                        .HasName("PK__Products__727E838BCD52AB72");

                    b.HasIndex(new[] { "CategoryId", "ItemName" }, "UQ__Products__6DED0D35DF735E0B")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.PromotionBulkItem", b =>
                {
                    ...
                    b.HasKey("PromotionBulkItemId")
                        .HasName("PK__Promotio__430AF235D93FE2B6");

                    b.HasIndex(new[] { "ItemId" }, "UQ__Promotio__727E838A54981948")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.PromotionCategory", b =>
                {
                    ...
                    b.HasKey("PromotionCategoryId")
                        .HasName("PK__Promotio__0D44A8A97E5AEF36");

                    b.HasIndex(new[] { "CategoryId" }, "UQ__Promotio__19093A0AF381DB2C")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.PromotionComboItem", b =>
                {
                    ...
                    b.HasKey("PromotionComboItemsId")
                        .HasName("PK__Promotio__DD97A31ED1351529");

                    b.HasIndex(new[] { "ItemId" }, "UQ__Promotio__727E838A08803F6B")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.PromotionItem", b =>
                {
                    ...
                    b.HasKey("PromotionItemId")
                        .HasName("PK__Promotio__2B1778CCAEC6FCD3");

                    b.HasIndex(new[] { "ItemId" }, "UQ__Promotio__727E838AB2C69DF5")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Reward", b =>
                {
                    ...
                    b.HasKey("RewardId")
                        .HasName("PK__Rewards__825015B99CC41D09");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.Role", b =>
                {
                    ...
                    b.HasKey("RoleId")
                        .HasName("PK__Roles__8AFACE1AEDA6B540");

                    b.HasIndex(new[] { "RoleName" }, "UQ__Roles__8A2B61608900FE1D")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.ShippingOption", b =>
                {
                    ...
                    b.HasKey("ShippingOptionId")
                        .HasName("PK__Shipping__642EC60DD0AF736B");

                    b.HasIndex(new[] { "ShippingOptionName" }, "UQ__Shipping__6AB401BA0EBAA0D5")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasKey("CartId")
                        .HasName("PK__Shopping__51BCD7B7B4CA8950");

                    b.HasIndex(new[] { "UserId" }, "UQ__Shopping__1788CC4DAE260870")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.User", b =>
                {
                    ...
                    b.HasKey("UserId")
                        .HasName("PK__Users__1788CC4CEE1128FD");

                    b.HasIndex("RoleId");

                    b.HasIndex(new[] { "Email" }, "UQ__Users__A9D10534F01F86E4")
                        .IsUnique()
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.UserAddress", b =>
                {
                    ...
                    b.HasKey("AddressId")
                        .HasName("PK__UserAddr__091C2AFBD89F8EAE");
            ...
            modelBuilder.Entity("SpiceCraft.Server.Models.UsersCredential", b =>
                {
                    ...
                    b.HasKey("UserCredentialId")
                        .HasName("PK__UsersCre__17C49DA7880A1738");

                    b.HasIndex(new[] { "UserId" }, "UQ__UsersCre__1788CC4DD565CE93")
                        .IsUnique();

                    b.HasIndex(new[] { "Username" }, "UQ__UsersCre__536C85E455E28F66")
                        .IsUnique();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SpiceCraft.Server.IndentityModels.ApplicationRole", null)
                        .WithMany()
