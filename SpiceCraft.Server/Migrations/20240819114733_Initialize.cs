    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__EnquiryT__BE8CFEFCCB11B2DA", x => x.EnquiryTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GiftCard__9FBB0CC1426F7A2A", x => x.GiftCardId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ItemCate__19093A0B42C61DF2", x => x.CategoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Rewards__825015B99B775E0C", x => x.RewardId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Roles__8AFACE1AC67D7E38", x => x.RoleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shipping__642EC60DF020D9B2", x => x.ShippingOptionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Enquiry__0A019B7D74A35F26", x => x.EnquiryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__727E838B78FDB901", x => x.ItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Promotio__0D44A8A9B968679C", x => x.PromotionCategoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CC4C6DCB8AE8", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Inventor__F5FDE6B37F73611C", x => x.InventoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ItemImag__7516F70C746EBBCD", x => x.ImageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Promotio__430AF235885C3231", x => x.PromotionBulkItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Promotio__DD97A31EF90EB47D", x => x.PromotionComboItemsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Promotio__2B1778CC51548A45", x => x.PromotionItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Customer__F382824D51FDDC6D", x => x.CustomerGiftCardId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Customer__2E79ECCE5DBB3D41", x => x.CustomerRewardsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Messages__C87C0C9C534E83A4", x => x.MessageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Notifica__20CF2E127CD16CA4", x => x.NotificationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__C3905BCFF5D1979B", x => x.OrderId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shopping__51BCD7B7E081C829", x => x.CartId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserAddr__091C2AFB46160253", x => x.AddressId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UsersCre__17C49DA7E7586F62", x => x.UserCredentialId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Invoices__D796AAB5AA06587D", x => x.InvoiceId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderDet__9DD74DBD90D8AE45", x => x.OrderDetailsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Payments__55433A6B62192BAA", x => x.TransactionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartItem__488B0B0A05C15EF9", x => x.CartItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__CartItem__F69B3F8E89576178",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__GiftCard__A25C5AA793AEB417",
                table: "GiftCards",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Inventor__727E838AAD16E96B",
                table: "Inventory",
                column: "ItemId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Invoices__C3905BCE9A7F914C",
                table: "Invoices",
                column: "OrderId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ItemCate__8517B2E09135E49F",
                table: "ItemCategories",
                column: "CategoryName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ItemImag__A7875E72032A32A7",
                table: "ItemImages",
                column: "ImageCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__OrderDet__64B7B3F6C6EDA6E9",
                table: "OrderDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Orders__A7F88E8F815996DE",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Products__6DED0D35CA70609C",
                table: "Products",
                columns: new[] { "CategoryId", "ItemName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Promotio__727E838A4403ACC9",
                table: "PromotionBulkItems",
                column: "ItemId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Promotio__19093A0A43511817",
                table: "PromotionCategories",
                column: "CategoryId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Promotio__727E838A084B98E7",
                table: "PromotionComboItems",
                column: "ItemId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Promotio__727E838A9C07C5D2",
                table: "PromotionItems",
                column: "ItemId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Roles__8A2B61603BC61A90",
                table: "Roles",
                column: "RoleName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Shipping__6AB401BAC296BC26",
                table: "ShippingOptions",
                column: "ShippingOptionName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Shopping__1788CC4DEC80A371",
                table: "ShoppingCarts",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D1053476A57CB2",
                table: "Users",
                column: "Email",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__UsersCre__1788CC4DBC625324",
                table: "UsersCredential",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__UsersCre__536C85E43264F094",
                table: "UsersCredential",
                column: "Username",
                unique: true);
        }
